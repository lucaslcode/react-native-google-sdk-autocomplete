...
+ (NSDictionary<NSString *, NSString *> *)mapping {
  ...
  dispatch_once(&once, ^{
    map = @{
      ...
      @"shortFormattedAddress": GMSPlacePropertyShortFormattedAddress,
      ...
      @"googleMapsUri": GMSPlacePropertyGoogleMapsURI,
      @"iconBackgroundColor": GMSPlacePropertyIconBackgroundColor,
      @"iconMaskUrl": GMSPlacePropertyIconImageURL,
      @"primaryType": GMSPlacePropertyPrimaryType,
      @"primaryTypeDisplayName": GMSPlacePropertyPrimaryTypeDisplayName,
      @"utcOffsetMinutes": GMSPlacePropertyUTCOffsetMinutes,
      @"currentOpeningHours": GMSPlacePropertyCurrentOpeningHours,
      @"currentSecondaryOpeningHours": GMSPlacePropertyCurrentSecondaryOpeningHours,
      @"internationalPhoneNumber": GMSPlacePropertyInternationalPhoneNumber,
      @"nationalPhoneNumber": GMSPlacePropertyPhoneNumber,
